...
Please note that this plugin only works on UNIX/Linux OS. Unfortunately it doesn't work with MAMP.
...
http://downloads.wordpress.org/plugin/wp-source-control.1.1.zip
